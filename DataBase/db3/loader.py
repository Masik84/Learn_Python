...
# Эта функция просто перебирает список уникальных компаний и, 
...
# Сохранение платежей
# Сохранение платежей выглядит похоже, только нам уже не нужно 
# проверять уникальность и получать идентификаторы
...
# Функция get_employee_id аналогична get_company_id
# Это не самый эффективный вариант решения этой задачи. 
# Эффективнее было бы превращать список словарей с данными 
# компаний/сотрудников в словарь типа {"Название компании": идентификатор}
